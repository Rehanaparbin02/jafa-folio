...
const InfiniteText = () => {
    ...
    return (
        <div className="relative flex w-full overflow-hidden bg-transparent py-19 relative top-80">
      ...
      */}
            ...
            >
                ...
                {[...Array(6)].map((_, i) => (
                    <span
                        key={i}
                        className={`${gondens.className} text-8xl md:text-[12rem] text-white px-12 tracking-wide uppercase select-none`}
                    >
                        {text}
                    </span>
                ))}
